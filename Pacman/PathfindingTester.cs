            ...
            else if (_currentState == SelectState.DestinationSelected)
            {
                ...
                if (mouseState.LeftButton == ButtonState.Released)
                {
                    ...
                    try
                    {
                        ...
                        ********************************************************************************/
                        Tile srcTile = Tile.ToTile(new Vector2(_srcPoint.X, _srcPoint.Y), _tiledMap.TileWidth, _tiledMap.TileHeight);
                        Tile destTile = Tile.ToTile(new Vector2(_destPoint.X, _destPoint.Y), _tiledMap.TileWidth, _tiledMap.TileHeight);
